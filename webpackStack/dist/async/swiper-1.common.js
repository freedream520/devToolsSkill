 ...
 */
        !function() {
            ...
            var a, t = function(e, s) {
                ...
                s = s || {};
                var v = {};
                for (var g in s) if ("object" != typeof s[g] || s[g].nodeType || s[g] === window || s[g] === document || void 0 !== r && s[g] instanceof r || "undefined" != typeof jQuery && s[g] instanceof jQuery) v[g] = s[g]; else {
                    v[g] = {};
                    for (var w in s[g]) v[g][w] = s[g][w];
                }
                for (var b in h) if (void 0 === s[b]) s[b] = h[b]; else if ("object" == typeof s[b]) for (var y in h[b]) void 0 === s[b][y] && (s[b][y] = h[b][y]);
                var T = this;
                if (T.params = s, T.originalParams = v, T.classNames = [], void 0 !== a && void 0 !== r && (a = r), 
                (void 0 !== a || (a = void 0 === r ? window.Dom7 || window.Zepto || window.jQuery : r)) && (T.$ = a, 
                T.currentBreakpoint = void 0, T.getActiveBreakpoint = function() {
                    ...
                    void 0 === f && (T.params.virtualTranslate = !0)), T.params.grabCursor && T.support.touch && (T.params.grabCursor = !1), 
                    ...
                    T.imagesToLoad = [], T.imagesLoaded = 0, T.loadImage = function(e, a, t, r, s) {
                        ...
                        function e() {
                            void 0 !== T && null !== T && (void 0 !== T.imagesLoaded && T.imagesLoaded++, T.imagesLoaded === T.imagesToLoad.length && (T.params.updateOnImagesReady && T.update(), 
                        ...
                        T.emit("onAutoplayStart", T), void o())));
                        ...
                        var l, d = T.params.slidesPerColumn, p = o / d, c = p - (T.params.slidesPerColumn * p - T.slides.length);
                        for (e = 0; e < T.slides.length; e++) {
                            l = 0;
                            var u = T.slides.eq(e);
                            if (T.params.slidesPerColumn > 1) {
                                var m, h, f;
                                "column" === T.params.slidesPerColumnFill ? (h = Math.floor(e / d), f = e - h * d, 
                                (h > c || h === c && f === d - 1) && ++f >= d && (f = 0, h++), m = h + f * o / d, 
                                u.css({
                                    ...
                                    "-webkit-order": m,
                                    order: m
                                })) : (f = Math.floor(e / p), h = e - f * p), u.css({
                                    "margin-top": 0 !== f && T.params.spaceBetween && T.params.spaceBetween + "px"
                                }).attr("data-swiper-column", h).attr("data-swiper-row", f);
                            }
                            "none" !== u.css("display") && ("auto" === T.params.slidesPerView ? (l = i() ? u.outerWidth(!0) : u.outerHeight(!0), 
                        ...
                        T.wrapper.css({
                            ...
                            for (v = [], e = 0; e < T.snapGrid.length; e++) T.snapGrid[e] < T.virtualSize + T.snapGrid[0] && v.push(T.snapGrid[e]);
                            T.snapGrid = v;
                        }
                        if (!T.params.centeredSlides) {
                            for (v = [], e = 0; e < T.snapGrid.length; e++) T.snapGrid[e] <= T.virtualSize - T.size && v.push(T.snapGrid[e]);
                            T.snapGrid = v, Math.floor(T.virtualSize - T.size) > Math.floor(T.snapGrid[T.snapGrid.length - 1]) && T.snapGrid.push(T.virtualSize - T.size);
                        }
                        ...
                        for (a = 0; a < T.slidesGrid.length; a++) void 0 !== T.slidesGrid[a + 1] ? r >= T.slidesGrid[a] && r < T.slidesGrid[a + 1] - (T.slidesGrid[a + 1] - T.slidesGrid[a]) / 2 ? e = a : r >= T.slidesGrid[a] && r < T.slidesGrid[a + 1] && (e = a + 1) : r >= T.slidesGrid[a] && (e = a);
                        (0 > e || void 0 === e) && (e = 0), t = Math.floor(e / T.params.slidesPerGroup), 
                        ...
                        e.prev("." + T.params.slideClass).addClass(T.params.slidePrevClass), T.bullets && T.bullets.length > 0) {
                            ...
                            t > T.bullets.length - 1 && (t -= T.bullets.length)) : t = void 0 !== T.snapIndex ? T.snapIndex : T.activeIndex || 0, 
                        ...
                        function a() {
                            t = Math.min(Math.max(T.translate, T.maxTranslate()), T.minTranslate()), T.setWrapperTranslate(t), 
                    ...
                    T.initEvents = function(e) {
                        var t = e ? "off" : "on", r = e ? "removeEventListener" : "addEventListener", i = "container" === T.params.touchEventsTarget ? T.container[0] : T.wrapper[0], n = T.support.touch ? i : document, o = !!T.params.nested;
                    ...
                    if (T.onTouchStart = function(e) {
                        ...
                        if (e.originalEvent && (e = e.originalEvent), !(O && "mousemove" === e.type || e.preventedByNestedSwiper)) {
                            ...
                            if (M && T.emit("onTouchMove", T, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                                ...
                                if (P && T.emit("onTouchMoveOpposite", T, e), void 0 === N && T.browser.ieTouch && (T.touches.currentX !== T.touches.startX || T.touches.currentY !== T.touches.startY) && (N = !0), 
                                S) {
                        ...
                        S) {
                            ...
                            if (s = T.params.followFinger ? T.rtl ? T.translate : -T.translate : -k, T.params.freeMode) {
                                ...
                                if (T.params.freeModeMomentum) {
                                    ...
                                    A.length = 0;
                                    var d = 1e3 * T.params.freeModeMomentumRatio, p = T.velocity * d, c = T.translate + p;
                                    T.rtl && (c = -c);
                                    var u, m = !1, h = 20 * Math.abs(T.velocity) * T.params.freeModeMomentumBounceRatio;
                                    if (c < T.maxTranslate()) T.params.freeModeMomentumBounce ? (c + T.maxTranslate() < -h && (c = T.maxTranslate() - h), 
                                    u = T.maxTranslate(), m = !0, D = !0) : c = T.maxTranslate(); else if (c > T.minTranslate()) T.params.freeModeMomentumBounce ? (c - T.minTranslate() > h && (c = T.minTranslate() + h), 
                                    u = T.minTranslate(), m = !0, D = !0) : c = T.minTranslate(); else if (T.params.freeModeSticky) {
                                        var f, v = 0;
                                        for (v = 0; v < T.snapGrid.length; v += 1) if (T.snapGrid[v] > -c) {
                                            f = v;
                                            break;
                                        }
                                        c = Math.abs(T.snapGrid[f] - c) < Math.abs(T.snapGrid[f - 1] - c) || "next" === T.swipeDirection ? T.snapGrid[f] : T.snapGrid[f - 1], 
                                        T.rtl || (c = -c);
                                    }
                                    if (0 !== T.velocity) d = T.rtl ? Math.abs((-c - T.translate) / T.velocity) : Math.abs((c - T.translate) / T.velocity); else if (T.params.freeModeSticky) return void T.slideReset();
                                    T.params.freeModeMomentumBounce && m ? (T.updateProgress(u), T.setWrapperTransition(d), 
                                    T.setWrapperTranslate(c), T.onTransitionStart(), T.animating = !0, T.wrapper.transitionEnd(function() {
                                        T && D && (T.emit("onMomentumBounce", T), T.setWrapperTransition(T.params.speed), 
                                        T.setWrapperTranslate(u), T.wrapper.transitionEnd(function() {
                                            T && T.onTransitionEnd();
                                        }));
                                    })) : T.velocity ? (T.updateProgress(c), T.setWrapperTransition(d), T.setWrapperTranslate(c), 
                            ...
                            var g, w = 0, b = T.slidesSizesGrid[0];
                            for (g = 0; g < T.slidesGrid.length; g += T.params.slidesPerGroup) void 0 !== T.slidesGrid[g + T.params.slidesPerGroup] ? s >= T.slidesGrid[g] && s < T.slidesGrid[g + T.params.slidesPerGroup] && (w = g, 
                            b = T.slidesGrid[g + T.params.slidesPerGroup] - T.slidesGrid[g]) : s >= T.slidesGrid[g] && (w = g, 
                            b = T.slidesGrid[T.slidesGrid.length - 1] - T.slidesGrid[T.slidesGrid.length - 2]);
                            var y = (s - T.slidesGrid[w]) / b;
                            if (r > T.params.longSwipesMs) {
                                if (!T.params.longSwipes) return void T.slideTo(T.activeIndex);
                                "next" === T.swipeDirection && (y >= T.params.longSwipesRatio ? T.slideTo(w + T.params.slidesPerGroup) : T.slideTo(w)), 
                                "prev" === T.swipeDirection && (y > 1 - T.params.longSwipesRatio ? T.slideTo(w + T.params.slidesPerGroup) : T.slideTo(w));
                            } else {
                        ...
                        void 0 === t && (t = !0), void 0 === e && (e = 0), 0 > e && (e = 0), T.snapIndex = Math.floor(e / T.params.slidesPerGroup), 
                        ...
                        return !(!T.params.allowSwipeToNext && s < T.translate && s < T.minTranslate()) && (!(!T.params.allowSwipeToPrev && s > T.translate && s > T.maxTranslate() && (T.activeIndex || 0) !== e) && (void 0 === a && (a = T.params.speed), 
                        ...
                        e && (T.emit("onTransitionStart", T), T.activeIndex !== T.previousIndex && (T.emit("onSlideChangeStart", T), 
                        ...
                        e && (T.emit("onTransitionEnd", T), T.activeIndex !== T.previousIndex && (T.emit("onSlideChangeEnd", T), 
                        T.activeIndex > T.previousIndex ? T.emit("onSlideNextEnd", T) : T.emit("onSlidePrevEnd", T))), 
                        T.params.hashnav && T.hashnav && T.hashnav.setHash();
                    }, T.slideNext = function(e, a, t) {
                        return T.params.loop ? !T.animating && (T.fixLoop(), T.container[0].clientLeft, 
                        ...
                        var t, r, s, i;
                        return void 0 === a && (a = "x"), T.params.virtualTranslate ? T.rtl ? -T.translate : T.translate : (s = window.getComputedStyle(e, null), 
                        ...
                        return void 0 === e && (e = i() ? "x" : "y"), T.getTranslate(T.wrapper[0], e);
                        ...
                        cube: {
                            setTranslate: function() {
                                ...
                                for (var r = 0; r < T.slides.length; r++) {
                                    ...
                                    var l = Math.max(Math.min(s[0].progress, 1), -1), d = 0, p = 0, c = 0;
                                    r % 4 == 0 ? (d = 4 * -o * T.size, c = 0) : (r - 1) % 4 == 0 ? (d = 0, c = 4 * -o * T.size) : (r - 2) % 4 == 0 ? (d = T.size + 4 * o * T.size, 
                                    c = T.size) : (r - 3) % 4 == 0 && (d = -T.size, c = 3 * T.size + 4 * T.size * o), 
                                    T.rtl && (d = -d), i() || (p = d, d = 0);
                                    var u = "rotateX(" + (i() ? 0 : -n) + "deg) rotateY(" + (i() ? n : 0) + "deg) translate3d(" + d + "px, " + p + "px, " + c + "px)";
                                    if (1 >= l && l > -1 && (t = 90 * r + 90 * l, T.rtl && (t = 90 * -r - 90 * l)), 
                                    s.transform(u), T.params.cube.slideShadows) {
                                        var m = i() ? s.find(".swiper-slide-shadow-left") : s.find(".swiper-slide-shadow-top"), h = i() ? s.find(".swiper-slide-shadow-right") : s.find(".swiper-slide-shadow-bottom");
                                        0 === m.length && (m = a('<div class="swiper-slide-shadow-' + (i() ? "left" : "top") + '"></div>'), 
                                        s.append(m)), 0 === h.length && (h = a('<div class="swiper-slide-shadow-' + (i() ? "right" : "bottom") + '"></div>'), 
                                        s.append(h)), s[0].progress, m.length && (m[0].style.opacity = -s[0].progress), 
                                        h.length && (h[0].style.opacity = s[0].progress);
                                    }
                                }
                                if (T.wrapper.css({
                                    ...
                                    var f = Math.abs(t) - 90 * Math.floor(Math.abs(t) / 90), v = 1.5 - (Math.sin(2 * f * Math.PI / 360) / 2 + Math.cos(2 * f * Math.PI / 360) / 2), g = T.params.cube.shadowScale, w = T.params.cube.shadowScale / v, b = T.params.cube.shadowOffset;
                                    e.transform("scale3d(" + g + ", 1, " + w + ") translate3d(0px, " + (T.height / 2 + b) + "px, " + -T.height / 2 / w + "px) rotateX(-90deg)");
                                }
                        ...
                        coverflow: {
                            setTranslate: function() {
                                for (var e = T.translate, t = i() ? -e + T.width / 2 : -e + T.height / 2, r = i() ? T.params.coverflow.rotate : -T.params.coverflow.rotate, s = T.params.coverflow.depth, n = 0, o = T.slides.length; o > n; n++) {
                                    var l = T.slides.eq(n), d = T.slidesSizesGrid[n], p = l[0].swiperSlideOffset, c = (t - p - d / 2) / d * T.params.coverflow.modifier, u = i() ? r * c : 0, m = i() ? 0 : r * c, h = -s * Math.abs(c), f = i() ? 0 : T.params.coverflow.stretch * c, v = i() ? T.params.coverflow.stretch * c : 0;
                                    Math.abs(v) < .001 && (v = 0), Math.abs(f) < .001 && (f = 0), Math.abs(h) < .001 && (h = 0), 
                                    Math.abs(u) < .001 && (u = 0), Math.abs(m) < .001 && (m = 0);
                                    var g = "translate3d(" + v + "px," + f + "px," + h + "px)  rotateX(" + m + "deg) rotateY(" + u + "deg)";
                                    if (l.transform(g), l[0].style.zIndex = 1 - Math.abs(Math.round(c)), T.params.coverflow.slideShadows) {
                                        var w = i() ? l.find(".swiper-slide-shadow-left") : l.find(".swiper-slide-shadow-top"), b = i() ? l.find(".swiper-slide-shadow-right") : l.find(".swiper-slide-shadow-bottom");
                                        0 === w.length && (w = a('<div class="swiper-slide-shadow-' + (i() ? "left" : "top") + '"></div>'), 
                                        l.append(w)), 0 === b.length && (b = a('<div class="swiper-slide-shadow-' + (i() ? "right" : "bottom") + '"></div>'), 
                                        l.append(b)), w.length && (w[0].style.opacity = c > 0 ? c : 0), b.length && (b[0].style.opacity = -c > 0 ? -c : 0);
                                    }
                                }
                                if (T.browser.ie) {
                        ...
                        loadImageInSlide: function(e, t) {
                            if (void 0 !== e && (void 0 === t && (t = !0), 0 !== T.slides.length)) {
                    ...
                    T.disableMousewheelControl = function() {
                        return !!T.mousewheel.event && (T.container.off(T.mousewheel.event, c), !0);
                    }, T.enableMousewheelControl = function() {
                        return !!T.mousewheel.event && (T.container.on(T.mousewheel.event, c), !0);
                    }, T.parallax = {
                        setTranslate: function() {
                    ...
                    for (var R in T.plugins) {
                        var W = T.plugins[R](T, T.params[R]);
                        W && T._plugins.push(W);
                    }
            ...
            var n;
            n = void 0 === r ? window.Dom7 || window.Zepto || window.jQuery : r, n && ("transitionEnd" in n.fn || (n.fn.transitionEnd = function(e) {
                function a(i) {
                    if (i.target === this) for (e.call(this, i), t = 0; t < r.length; t++) s.off(r[t], a);
                }
                var t, r = [ "webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd" ], s = this;
