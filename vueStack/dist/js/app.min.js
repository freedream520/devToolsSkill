...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "/chunk/" + ({"0":"login","1":"lists","2":"filmDetail"}[chunkId]||chunkId) + "-" + chunkId + ".common.js?" + {"0":"8ab106fe8e40ce39ec05","1":"c0955e5fc15e3c929fd2","2":"c60077e1f98c3276fe28","3":"1581495479421728020c"}[chunkId] + "";
...
exports.default = {
  data: function data() {
    return {
      title: "vue栈",
      activeIndex: 0,
      items: [{ text: "vue", icon: "icon-shouye", link: "/vue" }, { text: "router", icon: "icon-wodedingdan", link: "/router" }, { text: "vuex", icon: "icon-wodeyouhuiquan", link: "/vuex" }, { text: "电影", icon: "icon-wodejuhuasuan", link: "/lists" }]
    };
  },
  methods: {},
  computed: {},
