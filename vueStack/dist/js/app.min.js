...
/******/ 			script.src = __webpack_require__.p + "/chunk/" + ({"2":"login","4":"animate"}[chunkId]||chunkId) + "-" + chunkId + ".common.js?" + {"2":"b756d8a12f21f417f540","4":"a93184536e13d9b93706","5":"faa2c47ab3f8eebb4c27"}[chunkId] + "";
	...
	exports.default = {
	  data: function data() {
	    return {
	      title: "vue栈",
	      activeIndex: 0,
	      items: [{ text: "vue", icon: "icon-shouye", link: "/vue" }, { text: "router", icon: "icon-wodedingdan", link: "/router" }, { text: "vuex", icon: "icon-wodeyouhuiquan", link: "/vuex" }, { text: "动画", icon: "icon-wodejuhuasuan", link: "/animate" }]
	    };
	  },
	  methods: {},
	  computed: {},
