...
/******/ 			script.src = __webpack_require__.p + "/chunk/" + ({"1":"animate","2":"login"}[chunkId]||chunkId) + "-" + chunkId + ".common.js?" + {"1":"a5cc5c2aa9d834c625f7","2":"b756d8a12f21f417f540","3":"1df3f849bd747df162dc"}[chunkId] + "";
	...
	var routes = [{
		...
		children: [{
			...
			children: [{
				...
				path: "routerB",
				component: function component(resolve, reject) {
					__webpack_require__.e/* require */(3, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(62)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
				}
			}, {
				path: "routerC",
