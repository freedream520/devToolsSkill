...
var o = [{ text: "a", age: 123 }, { text: "b", age: 234 }];
...
var Dev = function Dev(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			"li",
			null,
			"1.github\u4E0A\u4E0B\u8F7D React Developer Tools  \uFF08\u9700\u8981\u7FFB\u5899\uFF09  ",
...
var Home = function (_Component2) {
	...
	_createClass(Home, [{
		...
		value: function componentWillMount() {
			...
			(0, _axios2.default)(banner).then(function (data) {
				self.setState({
					banner: data.data.data
				});
			});

			(0, _axios2.default)(homeListUrl).then(function (data) {
				self.setState({
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(Dev, null),
...
//# sourceMappingURL=Home-1.common.js.map?ff08ed3de49f1792c9d9